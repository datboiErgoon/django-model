...
class Album(models.Model):
    ...
    hodnoceni = models.IntegerField(max_length=2, validators=[MinValueValidator(1), MaxValueValidator(10)], verbose_name='Hodnocení', help_text='Ohodnoťte album')
...
class Pisen(models.Model):
    ...
    poradi = models.IntegerField(max_length=3, verbose_name='Pořadí stopy', help_text='Zadejte pořadí stopy')
